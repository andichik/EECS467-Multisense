...
const {calculatePixelPositions} = require('./map.js')
const {OCCUPY_THRESHOLD, NUM_PARTICLES} = require('./const.js')
...
module.exports = {ImportanceSampling, UpdateParticlesPose, UpdateParticlesWeight}
